<?php
    ...
    $html = "
        <div style='text-align: center; margin-bottom: 30px;'>
            ...
            <h4>RELATÓRIO DE BENS EM MAL ESTADO</h4>
        </div>";
    ...
    if ($res && $res->num_rows > 0) {
        ...
        $html .= "<p style='text-align: center; color: red;'>Nenhum equipamento em mal estado encontrado!</p>";
    }
